...
The magenta background was removed locally to produce the transparent `hero-car.png` fallback.
...
Outputs: `car-black.png`, `car-red.png`, and `car-green.png`.
...
Outputs: `service-shipping.png`, `service-warranty.png`, and `service-financing.png`.
